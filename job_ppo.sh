...
#BSUB -q hpc
### -- set the job Name --
#BSUB -J quadruped_rl_ppo_obstacles_fixed_vel_finetune
...
# python run_sb3_wandb.py --project-name quadruped_rl --run-name rand_vel_scratch_eth --save-path /work3/s243600 --learning-alg PPO --num-envs 40 --task_env ETH --observation_space_mode LR_COURSE_OBS_EXTENDED --total_timesteps 5000000 --learning_rate 3e-4 --max_episode_length 20 --learning_rate_adaptive --randomize_cpg_params True --randomize_velocity_command